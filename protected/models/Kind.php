	...
	*/
	...
	public function rules()
	{
		return array(
			...
			array('type_select_calcitem', 'length', 'max'=>255),
			array('name_text', 'length', 'max'=>255),
			array('price_text', 'length', 'max'=>255),
			array('info_bigtexteditor, hidden_nexttable_questions', 'length', 'max'=>2000),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'type_select_calcitem' => 'Type',
			'name_text' => 'Title',
			'price_text' => 'Price',
			'info_bigtexteditor' => 'Info',
			'hidden_nexttable_questions' => 'Questions',
		);
	}
