...
class BootActiveForm extends CActiveForm
{
	...
	// Input classes.
	const INPUT_HORIZONTAL = 'BootInputHorizontal';
	const INPUT_INLINE = 'BootInputInline';
	const INPUT_SEARCH = 'BootInputSearch';
	const INPUT_VERTICAL = 'BootInputVertical';
