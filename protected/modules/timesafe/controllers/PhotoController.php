<?php
class PhotoController extends RController
{
    ...
    public function actionList() {
        ...
        if (isset($_GET['Photo'])) {
            ...
            Yii::app()->user->setState('_filter_Photo', $_GET['Photo']);
        } else
            if (Yii::app()->user->hasState('_filter_Photo')) {
                $model->attributes = Yii::app()->user->getState('_filter_Photo');
            }
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Photo'])) {
            ...
            $model->imagelist=$this->saveFile($model,'imagelist');
    ...
    public function actionUpdate($id) {
        ...
        $this->performAjaxValidation($model);
        $page = (int)Yii::app()->request->getParam('Photo_page');
    ...
    public function beforeAction($action) {
        if ($_GET['ajax'] === 'state')
            if (count($_GET['PhotoCheck']) > 0) {
                foreach ($_GET['PhotoCheck'] as $column => $value) {
                    foreach ($value as $id => $val) {
                        Photo::model()->updateByPk((int)$id, array($column => (int)$val));
                    }
                }
                Yii::app()->end();
            }
