<?php
class ClubController extends RController
{
    public $filterOption = array(
        'model'  => 'Club',
        'fields' => array(            
            'parent_Ctype_id'=>array('type'=>'parent'),
    ...
    public function actionList() {
        ...
        if (isset($_GET['Club'])) {
            ...
            Yii::app()->user->setState('_filter_Club', $_GET['Club']);
        } else
            if (Yii::app()->user->hasState('_filter_Club')) {
                $model->attributes = Yii::app()->user->getState('_filter_Club');
            }
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['Club'])) {
            ...
            $model->logo=$this->saveFile($model,'logo');
    ...
    public function actionUpdate($id) {
        ...
        $this->performAjaxValidation($model);
        $page = (int)Yii::app()->request->getParam('Club_page');
    ...
    public function beforeAction($action) {
        if ($_GET['ajax'] === 'state')
            if (count($_GET['ClubCheck']) > 0) {
                foreach ($_GET['ClubCheck'] as $column => $value) {
                    foreach ($value as $id => $val) {
                        Club::model()->updateByPk((int)$id, array($column => (int)$val));
                    }
                }
                Yii::app()->end();
            }
