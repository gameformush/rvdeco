<?php
class KuponController extends RController
{
    ...
    public function actionList() {
        ...
        if (isset($_GET['Kupon'])) {
            ...
            Yii::app()->user->setState('_filter_Kupon', $_GET['Kupon']);
        } else
            if (Yii::app()->user->hasState('_filter_Kupon')) {
                $model->attributes = Yii::app()->user->getState('_filter_Kupon');
            }
    ...
    public function actionUpdate($id) {
        ...
        $this->performAjaxValidation($model);
        $page = (int)Yii::app()->request->getParam('Kupon_page');
    ...
    public function beforeAction($action) {
        if ($_GET['ajax'] === 'state')
            if (count($_GET['KuponCheck']) > 0) {
                foreach ($_GET['KuponCheck'] as $column => $value) {
                    foreach ($value as $id => $val) {
                        Kupon::model()->updateByPk((int)$id, array($column => (int)$val));
                    }
                }
                Yii::app()->end();
            }
