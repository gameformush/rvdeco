<?php
class FooterController extends RController
{
    ...
    public function actionList() {
        ...
        if (isset($_GET['Footer'])) {
            ...
            Yii::app()->user->setState('_filter_Footer', $_GET['Footer']);
        } else
            if (Yii::app()->user->hasState('_filter_Footer')) {
                $model->attributes = Yii::app()->user->getState('_filter_Footer');
            }
    ...
    public function actionUpdate($id) {
        ...
        $this->performAjaxValidation($model);
        $page = (int)Yii::app()->request->getParam('Footer_page');
    ...
    public function beforeAction($action) {
        if ($_GET['ajax'] === 'state')
            if (count($_GET['FooterCheck']) > 0) {
                foreach ($_GET['FooterCheck'] as $column => $value) {
                    foreach ($value as $id => $val) {
                        Footer::model()->updateByPk((int)$id, array($column => (int)$val));
                    }
                }
                Yii::app()->end();
            }
