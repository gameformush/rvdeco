<div class="module-title">
    <?=Forum::modelTitle()?>&nbsp;<a href="<?=$this->createUrl('create')?>" class="btn btn-success"><i class="icon-plus"></i> Добавить</a>
</div>

<div id="search-Forum-form">
    ...
    $(function () {
        $('.modal-delete').click(function(e){
          ...
          $.get('<?=$this->createUrl('remove')?>',{id:id},function(){
            $.fn.yiiListView.update($('#search-Forum-form .list-view').attr('id'));
            _refreshTrash();
          });
        });
