<div class="module-title">
    <?=Club::modelTitle()?>&nbsp;<a href="<?=$this->createUrl('create')?>" class="btn btn-success"><i class="icon-plus"></i> Добавить</a>
</div>

<div id="search-Club-form">
    ...
    $(function () {
        $('.modal-delete').click(function(e){
          ...
          $.get('<?=$this->createUrl('remove')?>',{id:id},function(){
            $.fn.yiiListView.update($('#search-Club-form .list-view').attr('id'));
            _refreshTrash();
          });
        });
