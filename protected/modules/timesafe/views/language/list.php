<div class="module-title">
     <?=Language::modelTitle()?>&nbsp;<a href="<?=$this->createUrl('create')?>" class="btn btn-success"><i class="icon-plus"></i> Добавить</a>
</div>
...
<div class="modal-body">
    <p>Вы действительно хотите удалить купон?</p>
    <strong></strong>
</div>
    ...
    $(function () {
        $('.modal-delete').click(function(e){
          ...
          $.get('<?=$this->createUrl('remove')?>',{id:id},function(){
            $.fn.yiiListView.update($('#search-Language-form .list-view').attr('id'));
            _refreshTrash();
          });
        });
