...
<div class="page-navi">
    ...
    if ($this->page > 1):?>
    <a href="<?=$left?>#top"><span class="link"> ← Ctrl <?=$array[Yii::app()->session->itemAt('language')]['pred']?></span></a>
    <? else: $left = '#'; ?>
     <span class="link"> ← Ctrl <?=$array[Yii::app()->session->itemAt('language')]['pred']?></span>
    <? endif;?>
       ...
       <a href="<?=$right?>#top"><span class="link"><?=$array[Yii::app()->session->itemAt('language')]['sled']?> Ctrl  →</span></a>
       <? else: $right = '#'; ?>
       <span class="link"><?=$array[Yii::app()->session->itemAt('language')]['sled']?> Ctrl  →</span>
       <? endif;?>
